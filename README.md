...
### Showcase Playground
A live, interactive playground is available in the `showcase/` directory or at [https://solum.pomilon.xyz/playground](https://solum.pomilon.xyz/playground). It allows you to test SOLUM in real-time and view the HTML and JSON AST outputs directly in your browser.
